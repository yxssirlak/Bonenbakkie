...
import { Menu as MenuIcon, X } from 'lucide-react'; // Menu iconen toegevoegd
...
const App = () => {
  ...
  // Sluit het mobiele menu automatisch als we naar een nieuwe pagina gaan
  useEffect(() => {
  ...
  return (
    <div className="page-shell">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between md:justify-center gap-6 nav-glass relative">
          
          <div className="flex items-center gap-4 md:absolute md:left-4 lg:left-8">
            <img src="/Logo_bonenbakkie.jpeg" alt="'t Bonenbakkie" className="h-10 w-10 sm:h-14 sm:w-14 rounded-full object-cover" />
