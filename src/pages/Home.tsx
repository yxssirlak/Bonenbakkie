  ...
  return (
    <main>
      ...
      <section id="home" data-nav-theme="dark" className="hero-section min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        {/* DE KOFFIEMACHINE: Kader is flink langer en groter gemaakt (h-[115%] en md:w-[75%]) */}
        <div 
          className="absolute right-[-15%] md:right-[-5%] top-1/2 transform -translate-y-1/2 w-[140%] md:w-[75%] h-[115%] z-0 pointer-events-none opacity-30"
          style={{ 
            backgroundImage: "url('/koffiemachine.png')", 
            backgroundSize: 'contain',
            backgroundPosition: 'center right',
            backgroundRepeat: 'no-repeat',
            /* Lichtbeige chique filter */
            filter: 'invert(1) sepia(0.15) saturate(0.4) brightness(1.6)' 
          }}
        />

        <div className="max-w-5xl mx-auto text-center hero-content -mt-24 z-10 relative">
