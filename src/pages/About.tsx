...
const About: React.FC = () => {
  return (
    <main>
      <section data-nav-theme="light" className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#FFFAF5' }}>
      ...
      <section id="contact" className="section-base py-12 bg-[var(--color-beige-warm)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-[2.5rem] border border-[#d4a574]/25 bg-white/95 p-10 shadow-xl">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4 text-[#3f2e1f]">Contact</h2>
            <p className="mb-6 text-[#6e5b49]">Heb je vragen over onze mobiele koffiecar, wil je een reservering maken of wil je ons boeken voor een event? Stuur ons een bericht of bel ons direct.</p>
            <div className="grid sm:grid-cols-2 gap-6 text-[#6e5b49]">
              <div>
