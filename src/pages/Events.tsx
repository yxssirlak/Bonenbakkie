...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert('Oeps, er ging iets mis bij het verzenden. Controleer de console voor details!');
    } finally {
            ...
            {isSuccess ? (
              <div className="glass-card p-12 border border-[#d4cab4]/30 bg-[#d4cab4]/10 text-center animate-fade-in-up h-full flex flex-col justify-center items-center">
                ...
                <p className="text-[#ebdad0] font-sans mb-8">
                  Bedankt voor je interesse! We hebben je gegevens succesvol ontvangen. We nemen zo snel mogelijk contact met je op voor de koffie-invulling van jouw evenement.
                </p>
                <button 
